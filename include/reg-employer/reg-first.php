<span class="auth-reg__title">Регистрация</span>

<form action="/lk/auth.php?reg=2&step=2" class="auth-reg__form" method="post">
    <div class="auth-reg__group">
        <label class="auth-reg__input input">
            <input type="text" placeholder="ИНН" class="input__field">
        </label>
    </div>
