...
<div class="auth-login">
    ...
    <form action="" class="auth-login__form">
        ...
        <label class="auth-login__input input input_has-icon">
            <input class="input__field" type="password" placeholder="Пароль" name="PASSWORD">
            <div class="input__icon js-password-toggle">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_5454_2719)">
        ...
        <a href="/lk/auth.php?pass=1" class="auth-login__forgot link">Забыли пароль?</a>

        <? if ($role == 1) : ?>
            <div class="auth-login__socials">
                <span class="auth-login__socials-title">Или войдите через:</span>
                <div class="auth-login__socials-list">
                    <button class="auth-login__socials-item btn btn_light btn_icon js-login-vk">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_5454_2324)">
                            ...
                            <defs>
                                <clipPath id="clip0_5454_2324">
                                    <rect width="24" height="24" fill="white" />
                                </clipPath>
                            </defs>
                        </svg>
                    </button>
                    <button class="auth-login__socials-item btn btn_light btn_icon js-login-tg">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_5454_2725)">
