                ...
                <div class="filter__list">
                    <div class="filter__group filter-group filter-group_price">
                        ...
                        <div class="js-prices-wrapper active">
                            ...
                            <div class="filter-group__price-wrapper filter-group__price-wrapper_single">
                                <label class="filter-group__input input input_has-icon">
                                    ...
                                    <div class="input__icon js-currency-icon">
                                        <!-- <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0_4687_14516)">
                            ...
                            <div class="filter-group__range">
                                <div class="range-slider range-slider_single js-single-range" data-min="0" data-max="900000"></div>
                            </div>
                                ...
                                <div class="select" data-id="period">
                                    <label class="filter-group__input select__input input input_has-icon">
                                        ...
                                        <div class="input__icon">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <g clip-path="url(#clip0_4687_14543)">
