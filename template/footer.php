        ...
        <div class="footer__row">
            <div class="footer__left">
                ...
                <p class="footer__info">
                    ...
                    ИНН 7 730 706 401, КПП 540 601 001, 630 099, Россия, г. Новосибирск, ул. Депутатская д. 46, 6 этаж,
                    офис 3063
                </p>
                ...
                <div class="footer__socials">
                    ...
                    <a href="#" class="footer__social-btn btn btn_icon btn_light">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g>
                                <path
                                    d="M17.0088 2.00195C19.7663 2.00207 22.0018 4.23766 22.002 6.99512V17.0068C22.0018 19.7643 19.7663 21.9999 17.0088 22H6.99707C4.23961 21.9999 2.00402 19.7643 2.00391 17.0068V6.99512C2.00402 4.23765 4.23961 2.00207 6.99707 2.00195H17.0088ZM12.1279 4.3916C7.91639 4.3916 4.36152 7.6505 4.36133 11.9824C4.36133 13.7963 4.69658 15.0488 4.99219 16.1729C5.24033 17.0852 5.45996 17.9212 5.45996 18.9102C5.56636 20.227 7.99246 19.457 8.75879 18.4717C9.97026 19.3474 10.6681 19.5674 12.168 19.5674C16.314 19.545 19.6594 16.1695 19.6455 12.0234C19.6455 7.81201 16.3429 4.39196 12.1279 4.3916ZM12.2295 8.13574V8.13965C14.3548 8.26151 15.9911 10.0632 15.9082 12.1904C15.7655 14.3133 13.9495 15.9313 11.8242 15.8291C11.1591 15.7757 10.5198 15.5482 9.9707 15.1689C9.63865 15.501 9.1053 15.9318 8.89355 15.8809C8.45204 15.7636 7.93385 13.5195 8.22559 11.6768C8.57958 9.45057 10.1785 8.03003 12.2295 8.13574Z"
                                    fill="#FC7827" />
                            </g>
                            <defs>
                                <clipPath>
            ...
            <div class="footer__right">
                <div class="footer__col">
                    ...
                    <ul class="footer__menu f-menu">
                        <li class="f-menu__item">
                            <a href="/pages/article.php<?= $params ?>" class="f-menu__link link">Правила составления
                                резюме</a>
                        </li>
                        <? if (!$auth || $auth != 'N'): ?>
                            <li class="f-menu__item">
                                <a href="/lk/job_seeker/resume-form.php<?= $params ?>" class="f-menu__link link">Создать
                                    резюме</a>
                            </li>
                        <? endif; ?>
                        <li class="f-menu__item">
                ...
                <div class="footer__col">
                    ...
                    <ul class="footer__menu f-menu">
                        <li class="f-menu__item">
                            <a href="/pages/article-5.php<?= $params ?>" class="f-menu__link link">Правила размещения
                                вакансии</a>
                        </li>
                        <? if (!$auth || $auth != 'N'): ?>
                            <li class="f-menu__item">
                                <a href="/lk/employer/vacancy-form.php<?= $params ?>" class="f-menu__link link">Разместить
                                    вакансию</a>
                            </li>
                        <? endif; ?>
                        <li class="f-menu__item">
                            <a href="/pages/rezumes.php?client=Y<?= $queryParams ?>" class="f-menu__link link">Каталог
                                резюме</a>
                        </li>
                    </ul>
                </div>
...
<div data-modal="quick_responce" class="modal responce-modal modal_small">
    <div class="modal__wrapper">
        ...
        <form class="modal__inner">
            <div class="responce-modal__title">
                Быстрый отклик
            </div>
            <div class="responce-modal__descr">
                Выберите резюме для быстрого отклика
            </div>
            <div class="responce-modal__inputs-wrapper">
                <div class="select">
                    <label class="select__input input_form input input_size-l input_has-icon input_has-avatar">
                        ...
                        <span class="input__icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M17.4775 8.9707C17.7704 8.67781 18.2451 8.67781 18.538 8.9707C18.8309 9.26359 18.8309 9.73835 18.538 10.0312L12.538 16.0312C12.2634 16.3059 11.8287 16.3233 11.5341 16.083L11.4775 16.0312L5.47748 10.0312C5.18459 9.73835 5.18459 9.26359 5.47748 8.9707C5.77038 8.67781 6.24514 8.67781 6.53803 8.9707L12.0078 14.4404L17.4775 8.9707Z" fill="#232323"/>
                            </svg>
                        </span>
                    </label>
...
<div data-modal="quick_call" class="modal responce-modal modal_small">
    <div class="modal__wrapper">
        <button class="modal__close js-modal-close icon-button">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g>
        ...
        <form class="modal__inner">
            ...
            <div class="responce-modal__descr">
                Выберите вакансию, для приглашения кандидата
            </div>
            <div class="responce-modal__inputs-wrapper">
                <div class="responce-modal__filters-select multiple-select multiple-select_single">
                    <label class="filter-group__input multiple-select__input">
                        <input class="multiple-select__field" type="text" name="category" placeholder="Выберите вакансию" readonly="">
                    ...
                    <div class="multiple-select__dropdown">
                        <ul class="multiple-select__dropdown-list" role="radiogroup" aria-label="Выберите вакансию">
                            <li class="multiple-select__option" data-value="vacancy-1" role="radio" aria-checked="false">
                                <div class="multiple-select__info">
                                    <span class="multiple-select__title">Название вакансии 1 ограниченное одной строкой</span>
                                    <span class="multiple-select__subtitle">Город вакансии</span>
                                </div>
                            </li>
                            <li class="multiple-select__option" data-value="vacancy-2" role="radio" aria-checked="false">
                                <div class="multiple-select__info">
                                    <span class="multiple-select__title">Название вакансии 2 ограниченное одной строкой</span>
                                    <span class="multiple-select__subtitle">Город вакансии</span>
                                </div>
                            </li>
                            <li class="multiple-select__option" data-value="vacancy-3" role="radio" aria-checked="false">
                                <div class="multiple-select__info">
                                    <span class="multiple-select__title">Название вакансии 3 ограниченное одной строкой</span>
                                    <span class="multiple-select__subtitle">Город вакансии</span>
                                </div>
                            </li>
                            <li class="multiple-select__option" data-value="vacancy-4" role="radio" aria-checked="false">
                                <div class="multiple-select__info">
                                    <span class="multiple-select__title">Название вакансии 4 ограниченное одной строкой</span>
                                    <span class="multiple-select__subtitle">Город вакансии</span>
                                </div>
                            </li>
                            <li class="multiple-select__option" data-value="vacancy-5" role="radio" aria-checked="false">
                                <div class="multiple-select__info">
                                    <span class="multiple-select__title">Название вакансии 5 ограниченное одной строкой</span>
                                    <span class="multiple-select__subtitle">Город вакансии</span>
                                </div>
                            </li>
                        </ul>
                ...
                <div class="textarea">
                    <textarea name="textarea" placeholder="Сообщение соискателю"></textarea>
                    <ul class="textarea__choices tags">
                        <li class="tags__item tag tag_btn js-textarea-choice" data-value="Готовы обсудить условия?">Готовы обсудить условия?</li>
                        <li class="tags__item tag tag_btn js-textarea-choice" data-value="Когда вам удобно созвониться?">Когда вам удобно созвониться?</li>
                        <li class="tags__item tag tag_btn js-textarea-choice" data-value="Предлагаю тестовое задание.">Предлагаю тестовое задание.</li>
                        <li class="tags__item tag tag_btn js-textarea-choice" data-value="Изучил ваше резюме. Вы нам подходите. Начнем диалог?">Изучил ваше резюме. Вы нам подходите. Начнем диалог?</li>
                        <li class="tags__item tag tag_btn js-textarea-choice" data-value="Нужен выход в ближайшие дни">Нужен выход в ближайшие дни</li>
                        <li class="tags__item tag tag_btn js-textarea-choice" data-value="Каковы ваши ожидания по зп?">Каковы ваши ожидания по зп?</li>
                    </ul>
                </div>
            </div>
            <button class="feedback__btn btn btn_primary btn_size-l">Связаться</button>
        </form>
    </div>
</div>
...
<div data-modal="saveSearch" class="modal registration-action-modal lk__modal">
    <div class="modal__wrapper">
        <button class="modal__close js-modal-close icon-button">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g>
        ...
        <p>Параметры поиска успешно сохранены в разделе Избранное</p>
        <div class="auth-hero__links">
            <a href="<?= $client && $client == 'Y' ? '/lk/employer/favorite.php?autoSearch=Y&auth=Y' : '/lk/job_seeker/favorite.php?autoSearch=Y&auth=Y'; ?>" class="auth-hero__link link active">Перейти</a>
        </div>
    </div>
</div>
        ...
        <form  method="post" class="lk__main-form lk__form">
            <div class="lk__main-form-inputs lk__form-inputs">
                <div class="lk__input-element">
                    ...
                    <div class="select" data-id="search_status">
                        <label class="filter-group__input select__input input input_has-icon">
                            <input class="input__field" type="text" name="search_status" data-id="search_status"
                                readonly placeholder="Активно ищу работу">
                            <span class="input__icon">
                ...
                <div class="lk__input-element">
                    ...
                    <div class="lk__input-wrapper">
                        <input type="text" value="" placeholder="Москва, Малая Тульская улица, 2/1 к5">
                    </div>
                </div>
                <div class="lk__input-element">
                    <span class="subcaption">Участник СВО</span>
                    <div class="lk__radio-buttons">
                        <label class="lk__input-radio radio">
                            <input class="radio__input" type="radio" name="svo" value="Y" checked="">
                            <span class="radio__label">Да</span>
                        </label>
                        <label class="lk__input-radio radio">
                            <input class="radio__input" type="radio" name="svo" value="N">
...
<div data-modal="add__user" class="modal lk__modal modal_small">
    <div class="modal__wrapper">
        <button class="modal__close js-modal-close icon-button">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g>
        ...
        <form method="post" class="lk__modal-form lk__user-form">
            ...
            <div class="lk__modal-form-content lk__form-inputs">
                <div class="lk__input-element">
                    <span class="subcaption">Должность</span>
                    <div class="lk__input-wrapper">
                        <input type="text" value="" placeholder="Должность пользователя">
                    </div>
                </div>
                <div class="lk__inputs-set">
                    <div class="lk__input-element">
                        <span class="subcaption">О пользователе</span>
                        <div class="lk__input-wrapper">
            ...
            <button type="submit" class="btn btn_size-m btn_primary">Cохранить</button>
        </form>
    </div>
</div>

<div data-modal="edit__user" class="modal lk__modal modal_small">
    <div class="modal__wrapper">
        <button class="modal__close js-modal-close icon-button">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g>
        ...
        <form method="post" class="lk__modal-form lk__user-form">
            ...
            <div class="lk__modal-form-content lk__form-inputs">
                <div class="lk__input-element">
                    <span class="subcaption">Должность</span>
                    <div class="lk__input-wrapper">
                        <input type="text" value="HR" placeholder="Должность пользователя">
                    </div>
                </div>
                <div class="lk__inputs-set">
                    <div class="lk__input-element">
                        <span class="subcaption">О пользователе</span>
                        <div class="lk__input-wrapper">
                            <input type="text" value="login" placeholder="Логин">
                        </div>
                    </div>
                    <div class="lk__input-element">
                        <div class="lk__input-wrapper">
                ...
                <div class="lk__inputs-set">
                    <div class="lk__input-element">
                        <span class="subcaption">Пароль</span>
                        <div class="lk__input-wrapper lk__btn_has-icon password-wrapper">
                            <input type="password" value="123456" placeholder="Пароль">
                            <button type="button" class="lk__btn_has-icon btn transp-btn" >
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g>
                    ...
                    <div class="lk__input-element">
                        <div class="lk__input-wrapper lk__btn_has-icon password-wrapper">
                            <input type="password" value="123456" placeholder="Повторите пароль">
                            <button type="button" class="lk__btn_has-icon btn transp-btn" >
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g>
            ...
            <div class="lk__main-form-inputs lk__form-inputs">
                ...
                <div class="lk__input-element">
                    ...
                    <div class="select" data-id="registration_type">
                        <label class="filter-group__input select__input input input_has-icon">
                            <input class="input__field" type="text" name="registration_type" data-id="registration_type"
                                readonly placeholder="Организация">
                            <span class="input__icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g>
                ...
                <div class="lk__input-element">
                    ...
                    <div class="select" data-id="activity_area">
                        <label class="filter-group__input select__input input input_has-icon">
                            <input class="input__field" type="text" name="activity_area" data-id="activity_area"
                                readonly placeholder="Медицинская клиника">
                            <span class="input__icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g>
                        ...
                        <div class="select__dropdown">
                            <ul class="select__dropdown-list" data-id="activity_area">
                                <li class="select__option active" data-value="Медицинская клиника">Медицинская клиника
                                </li>
            ...
            <div class="lk__univercity-form-inputs lk__form-inputs">
                <div class="lk__input-element">
                    ...
                    <div class="select" data-id="education">
                        <label class="filter-group__input select__input input input_has-icon">
                            <input class="input__field" type="text" name="education" data-id="education" readonly
                                placeholder="Высшее">
                            <span class="input__icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="lk__input-element">
                    ...
                    <div class="lk__input-grid lk__main-form__date-wrapper">
                        <div class="select" data-id="education_month">
                            <label class="filter-group__input select__input input input_has-icon">
                                <input class="input__field" type="text" name="education_month" data-id="education_month"
                                    readonly placeholder="Месяц">
                                <span class="input__icon">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g>
                        ...
                        <div class="select" data-id="education_year">
                            <label class="filter-group__input select__input input input_has-icon">
                                <input class="input__field" type="text" name="education_year" data-id="education_year"
                                    readonly placeholder="Год">
                                <span class="input__icon">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g>
            ...
            <div class="lk__language-form-inputs lk__form-inputs">
                <div class="lk__input-element">
                    ...
                    <div class="select" data-id="external_language">
                        <label class="filter-group__input select__input input input_has-icon">
                            <input class="input__field" type="text" name="external_language" data-id="external_language"
                                readonly placeholder="Английский">
                            <span class="input__icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g>
            ...
            <div class="lk__language-form-inputs lk__form-inputs">
                <div class="lk__input-element">
                    ...
                    <div class="select" data-id="internal_language">
                        <label class="filter-group__input select__input input input_has-icon">
                            <input class="input__field" type="text" name="internal_language" data-id="internal_language"
                                readonly placeholder="Английский">
                            <span class="input__icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
...
<div data-modal="favorite-comment" class="modal lk__modal">
    <div class="modal__wrapper">
        <button class="modal__close js-modal-close icon-button">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g>
        ...
        <form  method="post" class="lk__favorite-form lk__modal-form">
            ...
            <div class="textarea">
                <textarea data-mask="text" name="ddd" id="favorite-comment" placeholder="Комментарий"></textarea>
            </div>
            <button type="submit" class="btn btn_size-m btn_primary">
                <span>Добавить</span>
            </button>
...
<div data-modal="doc-modal" class="modal lk__modal">
    <div class="modal__wrapper">
        <button class="modal__close js-modal-close icon-button">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g>
...
<div data-modal="registration" class="modal registration-action-modal lk__modal">
    <div class="modal__wrapper">
        <button class="modal__close js-modal-close icon-button">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g>
        ...
        <p>Для просмотра полных данных и контактов кандидата, пожалуйста, авторизуйтесь</p>
        <div class="auth-hero__links">
            <a href="/lk/auth.php" class="auth-hero__link link active">Вход</a>
            <a href="/lk/auth.php?reg-auth=1" class="auth-hero__link link">Регистрация</a>
        </div>
    </div>
</div>

<div data-modal="searchNoAutorized" class="modal registration-action-modal lk__modal">
    <div class="modal__wrapper">
        <button class="modal__close js-modal-close icon-button">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g>
        ...
        <p>Для сохранения поисковых параметров, пожалуйста, авторизуйтесь</p>
        <div class="auth-hero__links">
            <a href="/lk/auth.php" class="auth-hero__link link active">Вход</a>
            <a href="/lk/auth.php?reg-auth=1" class="auth-hero__link link">Регистрация</a>
        </div>
...
<div data-modal="registration_2" class="modal registration-action-modal lk__modal">
    <div class="modal__wrapper">
        <button class="modal__close js-modal-close icon-button">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g>
        ...
        <p>Чтобы откликнуться на вакансию, пожалуйста, зарегистрируйтесь. Это займет всего 1 минуту — профиль создается
            автоматически!</p>
        <div class="auth-hero__links">
            <a href="/lk/auth.php" class="auth-hero__link link active">Вход</a>
            <a href="/lk/auth.php?reg-auth=1" class="auth-hero__link link">Быстрая регистрация</a>
        </div>
    </div>
</div>
...
<div data-modal="action-remove" class="modal chats__message-actions-modal">
    <div class="modal__wrapper">
        ...
        <div class="modal__content delete-approve">
            <span class="h3">Удалить</span>
            <div class="txt">
                <p>Вы уверены, что хотите удалить?</p>
                <p>Это действие нельзя будет отменить.</p>
            </div>
            <button class="btn btn_primary btn_size-m js-action-remove" type="button">
                <span>Удалить</span>
            </button>
        </div>
    </div>
...
*/
?>
<div data-modal="add-document" class="modal lk__modal inputs-files-block" data-files-type="noname">
    <div class="modal__wrapper">
        <button class="modal__close js-modal-close icon-button" type="button" aria-label="Закрыть">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <div class="modal__content">
            <div class="lk__modal-form lk__contacts-form">
                <p class="lk__modal-form-title">Добавить документ</p>
                <p>Вы можете загрузить файл в формате PDF, DOC, DOCX, общим размером не более 10мб.</p>
                <label class="file-input btn btn_primary btn_size-m">
                    <input type="file" name="add-document" class="js-file-input">
...
<script src="/assets/js/docx-preview.min.js"></script>
