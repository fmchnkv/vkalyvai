...
<div data-modal="edit__personal" class="modal lk__modal">
    <div class="modal__wrapper">
        <button class="modal__close js-modal-close icon-button">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_7682_28722)">
                    <path
                        d="M17.7324 7.5459L13.2773 12.001L17.7324 16.4561L16.46 17.7285L12.0049 13.2734L7.5498 17.7285L6.27734 16.4561L10.7324 12.001L6.27734 7.5459L7.5498 6.27344L12.0049 10.7285L16.46 6.27344L17.7324 7.5459Z"
                        fill="#999999" />
                </g>
                <defs>
                    <clipPath id="clip0_7682_28722">
                        <rect width="24" height="24" fill="white" />
                    </clipPath>
                </defs>
            </svg>
        ...
        <form action="" method="post" class="lk__main-form lk__form">
            <div class="lk__main-form-inputs lk__form-inputs">
                ...
                <div class="lk__input-element">
                    ...
                    <div class="lk__radio-buttons">
                        <label class="lk__input-wrapper">
                            <input type="radio" name="svo" value="Y">
                            <span class="lk__input-label">Да</span>
                        </label>
                        <label class="lk__input-wrapper">
                            <input type="radio" checked name="svo" value="N">
                            <span class="lk__input-label">Нет</span>
                        </label>
                    </div>
                </div>
            </div>
