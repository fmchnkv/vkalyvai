<h1 class="deals__title page-title lk__page-title">Мои резюме</h1>
<div class="deals-wrapper">
    <? require($_SERVER["DOCUMENT_ROOT"] . "/template/lk/deals/deals-list.php"); ?>
    <a href="/lk/job_seeker/resume-form.php?auth=Y" class="btn add-resume-btn detail__btn btn_primary btn_size-m">Добавить резюме</a>
</div>
<div class="deals__title-wrapper full-width">
    <h2 class="lk__section-title vacancies-title">Подходящие вакансии</h2>
    <a href="/pages/vacancies.php?auth=Y" class="vacancies-all-desk show-all-btn desk-elem transp-btn lk__btn_has-icon tab-elem icons-block">
...
<a href="/pages/vacancies.php?auth=Y" class="vacancies-all show-all-btn transp-btn lk__btn_has-icon mob-elem icons-block">
    <span>Смотреть все</span>
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g>
            <path
