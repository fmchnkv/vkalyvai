    ...
    <div class="offers-grid__item moderator__item lk-card">
        ...
        <ul class="offers-list__info offer-info">
            <li class="offer-info__item">
                ...
                <span>Медицинская клиника</span>
            </li>
            <li class="offer-info__item">
                <img src="/images/settings-icon.svg" alt="company icon">
                <span>Организация</span>
            </li>
            <li class="offer-info__item">
                <img src="/images/network-icon.svg" alt="company icon">
                <span>https://blueberry-digital.ru/</span>
            </li>
        </ul>
