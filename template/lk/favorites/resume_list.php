    ...
    <div class="lk-card__wrapper">
        <div class="offers-list__item lk-card favorite-list__item">
            <div class="offers-list__top">
                ...
                <div class="offers-list__actions offer-actions mob-elem ">
                ...
                <div class="offers-list__header offer-header">
                    <h3 class="offer-header__title"><a href="/pages/rezume.php"
            ...
            <div class="offers-list__bottom">
                ...
                <div class="offers-list__actions offer-actions desk-elem tab-elem">
                    <button class="share icon-button">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g >
                                <path
