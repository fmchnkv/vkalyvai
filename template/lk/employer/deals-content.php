...
<div class="deals-wrapper">
    ...
    <a href="/lk/employer/vacancy-form.php?auth=Y" class="btn add-resume-btn detail__btn btn_primary btn_size-m">Добавить вакансию</a>
</div>
<div class="section-title__wrapper employer__title-wrapper full-width">
    ...
    <a href="/pages/rezumes.php?client=Y&auth=Y" class="vacancies-all-desk show-all-btn desk-elem transp-btn lk__btn_has-icon tab-elem icons-block">
...
<a href="/pages/rezumes.php?client=Y&auth=Y" class="vacancies-all show-all-btn transp-btn lk__btn_has-icon mob-elem icons-block">
    <span>Смотреть все</span>
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g >
            <path
