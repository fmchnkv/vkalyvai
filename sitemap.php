...
$arMenu = [
    ...
    '/lk/job_seeker/favorite.php?autoSearch=Y' => 'ЛК - Избранное - автопоиск (Соискатель)',
    ...
    '/lk/employer/favorite.php?resume=Y' => 'ЛК - Избранные резюме (Работодатель)',
    '/lk/employer/favorite.php?autoSearch=Y' => 'ЛК - Избранное - автопоиск (Работодатель)',
