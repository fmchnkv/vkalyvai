				...
				<div class="inline-form__row">
					<div class="inline-form__input-wrapper">
						<label class="inline-form__label field">
							...
							<input class="field__input" type="text" name="search" placeholder="Кого вы ищете?">
						</label>
					</div>
				</div>
	...
	<div class="container">
		<div class="catalog__top catalog-header">
			...
			<div class="catalog-header__row">
				<span class="catalog-header__counter">Найдено 16 177 резюме</span>
...
<? require($_SERVER["DOCUMENT_ROOT"] . "/include/searching-save-rez.php"); ?>

<? require($_SERVER["DOCUMENT_ROOT"] . "/include/filter-rezumes.php"); ?>
