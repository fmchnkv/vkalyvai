                        ...
                        <div class="main-hero__input-wrapper main-hero__input-wrapper_text">
                            ...
                            <div class="field__dropdown js-without-choice" data-id="spec">
                                <ul class="field__dropdown-list">
                                    ...
                                    <li class="field__option js-select-item" data-value="Дизайнер">Дизайнер</li>
                                </ul>
                            </div>
                        </div>
    ...
    <div class="container">
        <div class="offers__inner">
            ...
            <div class="offers__nav">
                ...
                <a href="/pages/vacancies.php<?= $auth ? '?auth=' . urlencode($auth) : ''; ?>" class="btn btn_primary btn_size-m">Смотреть все вакансии</a>
            </div>
        </div>
    </div>
</section>
